...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/pria') ?>">
                    <i class="fas fa-seedling"></i>
                    <span>Pakaian Pria</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/wanita') ?>">
                    <i class="fa fa-wrench" aria-hidden="true"></i>
                    <span>Pakaian Muslimah</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/aksesoris') ?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Aksesoris Islami</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/buku') ?>">
                    <i class="fa fa-medkit" aria-hidden="true"></i>
                    <span>Buku & Kitab</span></a>
            </li>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="input-group form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        <input type="text" name="keyword" class="form-control bg-light border-0 small" placeholder="Cari Produk...">
